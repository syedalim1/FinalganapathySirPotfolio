  ...
  <section className="relative py-16 px-6 min-h-screen ">
    ...
    <div className="container mx-auto relative z-10">
      ...
      >
        {[
          ...
          <motion.div
            ...
            className="relative p-6 rounded-xl shadow-lg overflow-hidden group"
          >
            {/* Gradient background */}
            <motion.div
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="mb-8 bg-white/5 backdrop-blur-md p-6 rounded-2xl border border-white/10 shadow-lg"
      >
        <div className="flex flex-col md:flex-row gap-4 items-center">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-3 rounded-full hover:shadow-lg transition-all duration-300 flex items-center gap-2 relative overflow-hidden group"
            >
              <FaFilter />
              <span>Filter</span>
              <motion.div
        ...
        <motion.div
          ...
          className="mt-16 text-center p-8 bg-gradient-to-br from-indigo-900/70 to-purple-900/70 backdrop-blur-md rounded-2xl border border-white/10 shadow-lg"
        >
          <motion.div
            initial={{ scale: 0.8 }}
            whileInView={{ scale: 1 }}
